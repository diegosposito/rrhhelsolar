...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Read-only connection to the legacy Symfony 1.4 database (subset imported
        // into a separate schema) used only by the app:migrar-legacy command.
        'legacy' => [
            'driver' => 'mysql',
            'url' => env('LEGACY_DB_URL'),
            'host' => env('LEGACY_DB_HOST', env('DB_HOST', '127.0.0.1')),
            'port' => env('LEGACY_DB_PORT', env('DB_PORT', '3306')),
            'database' => env('LEGACY_DB_DATABASE', 'rrhh_legacy'),
